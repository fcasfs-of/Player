...
set_player_settings().size("zpreviewdemovideinz", "100%");   set_player_settings().position.center("zpreviewdemovideinz");    /*set_icon_controls("");*/    var app_plconfig_playlist={ search:true, autoplay:false };  var app_plconfig = { Playlist:app_plconfig_playlist, Controls:true, Title:true };  var controls_settings_buttons = { Icon:false, Speed_Control:true, Stop:true, Download:true };  set_player_controls_settings(controls_settings_buttons);set_player_config(app_plconfig);        set_player_settings().version_update();   set_player_settings().Button_Light(false);    /*set_player_settings().Scroll_to_MiniPlayer("zpreviewdemovideinz");*/
}
