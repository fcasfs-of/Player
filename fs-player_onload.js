...
var zzszhisdddceardsscz=document.getElementById(ob);     download_video_set_in=download_video_setdd;      
   ...
   var wqqzasdfdffsswwmdpssswwfltl = document.getElementById('lightcomme_box_modal');     wqqzasdfdffsswwmdpssswwfltl.innerHTML="<div style=1padding:4px;'>"+wqqzasdfsfgsswwfltl+"</div><br/><br/>";
