...
function add_fileset(zza, zz,nm,aaa,m,bb,nn) {   var adffffd_fileset="";   if(zza==true){  adffffd_fileset="display:none;";  }    var add_filesetsss=si_thudicon(aaa,zz,nm);      
    return '<li class="'+add_filesetsss.ic+'"><a class="'+add_filesetsss.ty.c+'" style="cursor:pointer;'+adffffd_fileset+'" onclick="ssdo_vieimad_vietdd(\''+m+'\', \''+nn+'\',\'\')">'+si_thud("<img src=\""+bb+"\" class=\"fa\"/>")+'<span '+add_filesetsss.ty.t+'>'+truncgate(nn)+'</span></a></li>';    }       
