...
function add_fileset(zz,nm,aaa,m,bb,nn) {   var add_filesetsss=si_thudicon(aaa,zz,nm);      
    return '<li class="'+add_filesetsss.ic+'"><a class="'+add_filesetsss.ty.c+'" style="cursor:pointer;display:none;" onclick="ssdo_vieimad_vietdd(\''+m+'\', \''+nn+'\',\'\')">'+si_thud("<img src=\""+bb+"\" class=\"fa\"/>")+'<span '+add_filesetsss.ty.t+'>'+truncgate(nn)+'</span></a></li>';    }       
...
targf_ddlist_filesaaaet=targf_ddlist_filesaaaet+add_fileset("music",true,true,loacol9d+"/audio/711000175000002220124101.html","https://fcasfs-of.github.io/Player/Server/Files/Audio_Spectrum-648789.jpg","Space Squad: Gavan vs Dekaranger - music 01");
...
targf_ddlist_filesaaaet=targf_ddlist_filesaaaet+add_fileset("photo",true,true,loacol9d+"/photo/421440570524407187054454.html","https://archive.org/download/784757575712/78 (9).jpg","Juspion: MacGaren 1");
