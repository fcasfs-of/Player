...
function download_video_setdd(d, v) {  var ex_loadex_downnd=fmdplex_loadex_txv(v.getAttribute("src"));  if(ex_loadex_downnd==""){   }  else {  
 ...
 v.pause();  
box_in_set("false","light_box_modal","box_btns","video",ex_loadex_downnd,"<a id=\"down_id_mdoo\" style=\"padding:3px;pointer-events:auto;cursor:pointer;\">Download File</a>",fmdplex_loadex_txv(v.getAttribute("poster")), v.volume, v.currentTime, v.playbackRate);
...
var zzszhirtertceardsscz=document.getElementById("down_id_mdoo");   var zxdownfgdgdgdloadBtn = document.getElementById('download_btns');  zzszhirtertceardsscz.onclick=function(){zxdownfgdgdgdloadBtn.click();};  
}   }  
